function despedida(){
	window.open("C:/BADYGS/seriesNumericas/BienvenidaSeriesNumericas.html");//función para abrir el cuestionario siguiente
	//window.close(this);
}
	...
	//comparación de respuestas estudiante y respuesta correcta con contador
		...
		respuestaPrueba(arregloRespuestas);//arreglo respuestas según valor del radiobutton seleccionado

		for (var i = 1; i < 2; i++) {
			
			if (arregloRespuestas[1]=="b1") {//comparación de respuestas estudiante/correcta
				correctas++;//aumento contador
			} else {
				correctas;
			}
			if (arregloRespuestas[2]=="h2") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[3]=="k3") {
				correctas++;
			} else {
				correctas;
			}
			...
			if (arregloRespuestas[5]=="z5") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[6]=="c6") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[7]=="g7") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[8]=="o8") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[9]=="s9") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[10]=="v10") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[11]=="b11") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[12]=="j12") {
				correctas++;
			} else {
				correctas;
			}
			...
			if (arregloRespuestas[14]=="r14") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[15]=="w15") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[16]=="d16") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[17]=="j17") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[18]=="k18") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[19]=="s19") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[20]=="x20") {
				correctas++;
			} else {
				correctas;
			}
			...
			if (arregloRespuestas[22]=="g22") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[23]=="k23") {
				correctas++;
			} else {
				correctas;
			}
			...
			if (arregloRespuestas[25]=="y25") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[26]=="e26") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[27]=="g27") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[28]=="n28") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[29]=="r29") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[30]=="z30") {
				correctas++;
			} else {
				correctas;
			}
