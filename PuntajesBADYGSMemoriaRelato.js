...
function compararRespuestas(){//función principal
	...
	for (var i = 1; i < 2; i++) {//recorrido del arreglo
		if (arregloRespuestas[1]=="f1") {//comparación de respuestas estudiante/correcta
			correctas++;//contador en aumento
		} else {
			correctas;
		}
		if (arregloRespuestas[2]=="l2") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[3]=="p3") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[4]=="x4") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[5]=="a5") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[6]=="h6") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[7]=="l7") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[8]=="r8") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[9]=="w9") {
			correctas++;
		} else {
			correctas;
		}
		...
		if (arregloRespuestas[12]=="k12") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[13]=="r13") {
			correctas++;
		} else {
			correctas;
		}
		...
		if (arregloRespuestas[15]=="a15") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[16]=="g16") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[17]=="m17") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[18]=="q18") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[19]=="v19") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[20]=="c20") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[21]=="g21") {
			correctas++;
		} else {
			correctas;
		}
		...
		if (arregloRespuestas[26]=="h26") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[27]=="k27") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[28]=="p28") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[29]=="x29") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[30]=="a30") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[31]=="g31") {
			correctas++;
		} else {
			correctas;
		}
