...
function despedida(){
	...
	//comparación de respuestas estudiante y respuesta correcta con contador
		...
		for (var i = 1; i < 2; i++) {
			...
			if (arregloRespuestas[1]=="w1") {///comparación de respuestas estudiante/correcta
				correctas++;//aumento contador
			} else {
				correctas;
			}
			if (arregloRespuestas[2]=="a2") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[3]=="g3") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[4]=="m4") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[5]=="p5") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[6]=="w6") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[7]=="a7") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[8]=="h8") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[9]=="k9") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[10]=="p10") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[11]=="x11") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[12]=="b12") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[13]=="g13") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[14]=="m14") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[15]=="q15") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[16]=="w16") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[17]=="b17") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[18]=="h18") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[19]=="k19") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[20]=="r20") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[21]=="v21") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[22]=="b22") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[23]=="f23") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[24]=="m24") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[25]=="r25") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[26]=="v26") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[27]=="b27") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[28]=="f28") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[29]=="m29") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[30]=="p30") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[31]=="x31") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[32]=="a32") {
				correctas++;
			} else {
				correctas;
			}
