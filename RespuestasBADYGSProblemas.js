...
function matrizBaremacionProblemas(matrizBaremacion){//matriz baremación
	...
	matrizBaremacion[1][0]="0";//respuestas correctas obtenidas
 	...
 	matrizBaremacion[2][1]="2";
 	matrizBaremacion[2][2]="Muy Bajo";

 	matrizBaremacion[3][0]="2";
 	matrizBaremacion[3][1]="4";
  	matrizBaremacion[3][2]="Muy Bajo";

 	matrizBaremacion[4][0]="3";
 	matrizBaremacion[4][1]="6";
 	matrizBaremacion[4][2]="Muy Bajo";

 	matrizBaremacion[5][0]="4";
 	matrizBaremacion[5][1]="8";
 	matrizBaremacion[5][2]="Bajo";

 	matrizBaremacion[6][0]="5"; 	
 	matrizBaremacion[6][1]="11";
 	matrizBaremacion[6][2]="Bajo";

 	matrizBaremacion[7][0]="6";
 	matrizBaremacion[7][1]="13";
 	matrizBaremacion[7][2]="Bajo";

  	matrizBaremacion[8][0]="7";
 	matrizBaremacion[8][1]="18";
 	matrizBaremacion[8][2]="Medio Bajo";

	matrizBaremacion[9][0]="8";
 	matrizBaremacion[9][1]="23";
 	matrizBaremacion[9][2]="Medio Bajo";

 	matrizBaremacion[10][0]="9";
 	matrizBaremacion[10][1]="30";
 	matrizBaremacion[10][2]="Medio Bajo";
 	
 	matrizBaremacion[11][0]="10";
 	matrizBaremacion[11][1]="38";
 	matrizBaremacion[11][2]="Medio";
 	
 	matrizBaremacion[12][0]="11";
 	matrizBaremacion[12][1]="41";
 	matrizBaremacion[12][2]="Medio";

 	matrizBaremacion[13][0]="12";
 	matrizBaremacion[13][1]="46";
 	matrizBaremacion[13][2]="Medio";

 	matrizBaremacion[14][0]="13";
 	matrizBaremacion[14][1]="59";
 	matrizBaremacion[14][2]="Medio";

 	matrizBaremacion[15][0]="14";
 	matrizBaremacion[15][1]="70";
 	matrizBaremacion[15][2]="Medio Alto";

 	matrizBaremacion[16][0]="15";
 	matrizBaremacion[16][1]="80";
 	matrizBaremacion[16][2]="Medio Alto";

 	matrizBaremacion[17][0]="16";
 	matrizBaremacion[17][1]="85";
 	matrizBaremacion[17][2]="Alto";

 	matrizBaremacion[18][0]="17";
 	matrizBaremacion[18][1]="89";
 	matrizBaremacion[18][2]="Alto";

 	matrizBaremacion[19][0]="18";
 	matrizBaremacion[19][1]="92";
 	matrizBaremacion[19][2]="Alto";

 	matrizBaremacion[20][0]="19";
 	matrizBaremacion[20][1]="95";
 	matrizBaremacion[20][2]="Muy Alto";

 	matrizBaremacion[21][0]="20";
 	matrizBaremacion[21][1]="96";
 	matrizBaremacion[21][2]="Muy Alto";

 	matrizBaremacion[22][0]="21";
 	matrizBaremacion[22][1]="96";
 	matrizBaremacion[22][2]="Muy Alto";

 	matrizBaremacion[23][0]="22";
 	matrizBaremacion[23][1]="97";
 	matrizBaremacion[23][2]="Muy Alto";

 	matrizBaremacion[24][0]="23";
 	matrizBaremacion[24][1]="98";
 	matrizBaremacion[24][2]="Muy Alto";

 	matrizBaremacion[25][0]="24";
 	matrizBaremacion[25][1]="99";
 	matrizBaremacion[25][2]="Muy Alto";
 	
 	matrizBaremacion[26][0]="25";
 	matrizBaremacion[26][1]="99";
 	matrizBaremacion[26][2]="Muy Alto";

 	matrizBaremacion[27][0]="26";
 	matrizBaremacion[27][1]="99";
 	matrizBaremacion[27][2]="Muy Alto";

 	matrizBaremacion[28][0]="27";
 	matrizBaremacion[28][1]="99";
 	matrizBaremacion[28][2]="Muy Alto";

 	matrizBaremacion[29][0]="28";
 	matrizBaremacion[29][1]="99";
 	matrizBaremacion[29][2]="Muy Alto";

 	matrizBaremacion[30][0]="29";
 	matrizBaremacion[30][1]="99";
 	matrizBaremacion[30][2]="Muy Alto";

 	matrizBaremacion[31][0]="30";
 	matrizBaremacion[31][1]="99";
 	matrizBaremacion[31][2]="Muy Alto";

 	matrizBaremacion[32][0]="31";
 	matrizBaremacion[32][1]="99";
