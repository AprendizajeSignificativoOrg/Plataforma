function despedida(){
		window.location="http://localhost/BADYGM/completarOraciones/BienvenidaBADYGMCompletarOraciones.html";
	}
	...
	function compararRespuestas(){//funcción principal
		...
		for (var i = 1; i < 2; i++) {
			...
			if (arregloRespuestas[1]=="l") {//comparación de respuestas estudiante/correcta
				correctas++;//aumento contador
			} else {
				correctas;
			}
			if (arregloRespuestas[2]=="s") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[3]=="y") {
				correctas++;
			} else {
				correctas;
			}
			...
			if (arregloRespuestas[5]=="j") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[6]=="m") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[7]=="q") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[8]=="z") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[9]=="c") {
				correctas++;
			} else {
				correctas;
			}
			...
			if (arregloRespuestas[11]=="k") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[12]=="s") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[13]=="z") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[14]=="a") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[15]=="h") {
				correctas++;
			} else {
				correctas;
			}
			...
			if (arregloRespuestas[17]=="t") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[18]=="v") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[19]=="e") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[20]=="j") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[21]=="n") {
				correctas++;
			} else {
				correctas;
			}
			...
			if (arregloRespuestas[23]=="z") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[24]=="a") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[25]=="h") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[26]=="n") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[27]=="q") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[28]=="x") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[29]=="a") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[30]=="g") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[31]=="n") {
				correctas++;
			} else {
				correctas;
			}
