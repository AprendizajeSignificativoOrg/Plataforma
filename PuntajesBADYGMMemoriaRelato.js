//ALGORITMO DE CAPTURA DE RESPUESTAS MEMORIA RELATO ORAL
	function despedida(){
		window.open("C:/BADYGM/memoriaVisualOrtografica/BienvenidaBADYGMMemoriaOrtografica.html");//Función para abrir el siguiente cuestionario
	//window.close(this);
}
	var  correctas=0;//contador respuestas correctas
	
function compararRespuestas(){//función principal
	despedida();//llamada función
	...
	for (var i = 1; i < 2; i++) {//recorrido del arreglo
		if (arregloRespuestas[1]=="f") {//comparación de respuestas
			correctas++;//contador en aumento
		} else {
			correctas;
		}
		if (arregloRespuestas[2]=="l") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[3]=="p") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[4]=="x") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[5]=="a") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[6]=="h") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[7]=="l") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[8]=="r") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[9]=="w") {
			correctas++;
		} else {
			correctas;
		}
		...
		if (arregloRespuestas[12]=="k") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[13]=="r") {
			correctas++;
		} else {
			correctas;
		}
		...
		if (arregloRespuestas[15]=="a") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[16]=="g") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[17]=="m") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[18]=="q") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[19]=="v") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[20]=="c") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[21]=="g") {
			correctas++;
		} else {
			correctas;
		}
		...
		if (arregloRespuestas[26]=="h") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[27]=="k") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[28]=="p") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[29]=="x") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[30]=="a") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[31]=="g") {
			correctas++;
		} else {
			correctas;
		}
