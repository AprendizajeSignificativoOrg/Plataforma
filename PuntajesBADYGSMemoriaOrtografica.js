...
function despedida(){
		window.location="http://localhost/BADYGS/discriminarDiferencias/BienvenidaDiscriminarDiferencias.html";//función para abrir el cuestionario siguiente
...
function compararRespuestas(){//función principal
	...
	for (var i = 1; i < 2; i++) {//recorrido del arreglo
		if (arregloRespuestas[1]=="m1") {//comparación de respuestas estudiante/correcta
			correctas++;//contador en aumento
		} else {
			correctas;
		}
		if (arregloRespuestas[2]=="r2") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[3]=="w3") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[4]=="c4") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[5]=="g5") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[6]=="k6") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[7]=="p7") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[8]=="w8") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[9]=="b9") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[10]=="f10") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[11]=="l11") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[12]=="r12") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[13]=="v13") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[14]=="c14") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[15]=="g15") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[16]=="k16") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[17]=="q17") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[18]=="x18") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[19]=="c19") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[20]=="f20") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[21]=="k21") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[22]=="q22") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[23]=="v23") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[24]=="c24") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[25]=="g25") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[26]=="k26") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[27]=="r27") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[28]=="w28") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[29]=="c29") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[30]=="f30") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[31]=="k31") {
			correctas++;
		} else {
			correctas;
		}
		if (arregloRespuestas[32]=="q32") {
			correctas++;
		} else {
			correctas;
		}
