//Matriz de respuestas matrices figuras
function matrizRespuestasMatrices(matrizRespuestas){

	matrizRespuestas[1][0]="1";//item pregunta
	matrizRespuestas[1][1]="l1";//respuesta correcta
	matrizRespuestas[1][2]="";//respuesta estudiante

	matrizRespuestas[2][0]="2";
	matrizRespuestas[2][1]="s2";
	matrizRespuestas[2][2]="";

	matrizRespuestas[3][0]="3";
	matrizRespuestas[3][1]="y3";
...
//Matriz de baremación matrices figuras
function matrizBaremacionMatrices(matrizBaremacion){

	matrizBaremacion[1][0]="0";//respuestas correctas/puntaje directo
	matrizBaremacion[1][1]="1";//puntaje convertido baremación
	matrizBaremacion[1][2]="Muy Bajo";//puntaje convertido escala
	...
	matrizBaremacion[4][1]="2";
	matrizBaremacion[4][2]="Muy Bajo";

	matrizBaremacion[5][0]="4";
	matrizBaremacion[5][1]="3";
	matrizBaremacion[5][2]="Muy Bajo";

	matrizBaremacion[6][0]="5";
	matrizBaremacion[6][1]="5";
	matrizBaremacion[6][2]="Muy Bajo";

	matrizBaremacion[7][0]="6";
	matrizBaremacion[7][1]="6";
	matrizBaremacion[7][2]="Muy Bajo";

	matrizBaremacion[8][0]="7";
	matrizBaremacion[8][1]="9";
	matrizBaremacion[8][2]="Bajo";

	matrizBaremacion[9][0]="8";
	matrizBaremacion[9][1]="11";
	matrizBaremacion[9][2]="Bajo";

	matrizBaremacion[10][0]="9";
	matrizBaremacion[10][1]="15";
	matrizBaremacion[10][2]="Medio Bajo";

	matrizBaremacion[11][0]="10";
	matrizBaremacion[11][1]="18";
	matrizBaremacion[11][2]="Medio Bajo";

	matrizBaremacion[12][0]="11";
	matrizBaremacion[12][1]="23";
	matrizBaremacion[12][2]="Medio Bajo";

	matrizBaremacion[13][0]="12";
	matrizBaremacion[13][1]="27";
	matrizBaremacion[13][2]="Medio Bajo";

	matrizBaremacion[14][0]="13";
	matrizBaremacion[14][1]="34";
	matrizBaremacion[14][2]="Medio";

	matrizBaremacion[15][0]="14";
	matrizBaremacion[15][1]="38";
	matrizBaremacion[15][2]="Medio";

	matrizBaremacion[16][0]="15";
	matrizBaremacion[16][1]="46";
	matrizBaremacion[16][2]="Medio";

	matrizBaremacion[17][0]="16";
	matrizBaremacion[17][1]="50";
	matrizBaremacion[17][2]="Medio";

	matrizBaremacion[18][0]="17";
	matrizBaremacion[18][1]="54";
	matrizBaremacion[18][2]="Medio";

	matrizBaremacion[19][0]="18";
	matrizBaremacion[19][1]="59";
	matrizBaremacion[19][2]="Medio";

	matrizBaremacion[20][0]="19";
	matrizBaremacion[20][1]="66";
	matrizBaremacion[20][2]="Medio";

	matrizBaremacion[21][0]="20";
	matrizBaremacion[21][1]="73";
	matrizBaremacion[21][2]="Medio Alto";

	matrizBaremacion[22][0]="21";
	matrizBaremacion[22][1]="77";
	matrizBaremacion[22][2]="Medio Alto";

	matrizBaremacion[23][0]="22";
	matrizBaremacion[23][1]="80";
	matrizBaremacion[23][2]="Medio Alto";

	matrizBaremacion[24][0]="23";
	matrizBaremacion[24][1]="85";
	matrizBaremacion[24][2]="Alto";

	matrizBaremacion[25][0]="24";
	matrizBaremacion[25][1]="89";
	matrizBaremacion[25][2]="Alto";

	matrizBaremacion[26][0]="25";
	matrizBaremacion[26][1]="92";
	matrizBaremacion[26][2]="Alto";

	matrizBaremacion[27][0]="26";
	matrizBaremacion[27][1]="94";
	matrizBaremacion[27][2]="Muy Alto";

	matrizBaremacion[28][0]="27";
	matrizBaremacion[28][1]="97";
