function despedida(){
		window.location='http://localhost/BADYGM/matricesDeFiguras/BienvenidaBADYGMMatricesFiguras.html';//función para pasar de cuestionario
	...
	//comparación de respuestas estudiante y respuesta correcta con contador
		...
		for (var i = 1; i < 2; i++) {
			...
			if (arregloRespuestas[1]=="h") {//comparación de respuestas estudiante/correcta
				correctas++;//aumento contador
			} else {
				correctas;
			}
			if (arregloRespuestas[2]=="n") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[3]=="q") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[4]=="v") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[5]=="d") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[6]=="g") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[7]=="m") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[8]=="p") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[9]=="y") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[10]=="a") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[11]=="g") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[12]=="l") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[13]=="p") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[14]=="x") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[15]=="e") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[16]=="f") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[17]=="l") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[18]=="t") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[19]=="y") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[20]=="d") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[21]=="h") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[22]=="k") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[23]=="r") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[24]=="w") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[25]=="c") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[26]=="i") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[27]=="n") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[28]=="t") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[29]=="w") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[30]=="c") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[31]=="f") {
				correctas++;
			} else {
				correctas;
			}
			if (arregloRespuestas[32]=="m") {
				correctas++;
			} else {
				correctas;
			}
