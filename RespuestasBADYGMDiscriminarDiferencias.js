// Matriz respuestas discriminar diferencias
function matrizRespuestasDiferencias(matrizRespuestas){

	matrizRespuestas[1][0]="1";//item pregunta
	matrizRespuestas[1][1]="r";//respuesta correcta
	matrizRespuestas[1][2]="";//respuesta estudiante

	matrizRespuestas[2][0]="2";
	matrizRespuestas[2][1]="v";
...
function matrizBaremacionDiferencias(matrizBaremacion){
	...
	matrizBaremacion[9][1]="1";
	matrizBaremacion[9][2]="Muy Bajo";

	matrizBaremacion[10][0]="9";
	matrizBaremacion[10][1]="1";
	matrizBaremacion[10][2]="Muy Bajo";

	matrizBaremacion[11][0]="10";
	matrizBaremacion[11][1]="1";
	matrizBaremacion[11][2]="Muy Bajo";

	matrizBaremacion[12][0]="11";
	matrizBaremacion[12][1]="1";
	matrizBaremacion[12][2]="Muy Bajo";

	matrizBaremacion[13][0]="12";
	matrizBaremacion[13][1]="2";
	matrizBaremacion[13][2]="Muy Bajo";

	matrizBaremacion[14][0]="13";
	matrizBaremacion[14][1]="3";
	matrizBaremacion[14][2]="Muy Bajo";

	matrizBaremacion[15][0]="14";
	matrizBaremacion[15][1]="4";
	matrizBaremacion[15][2]="Muy Bajo";

	matrizBaremacion[16][0]="15";
	matrizBaremacion[16][1]="8";
	matrizBaremacion[16][2]="Bajo";

	matrizBaremacion[17][0]="16";
	matrizBaremacion[17][1]="13";
	matrizBaremacion[17][2]="Bajo";

	matrizBaremacion[18][0]="17";
	matrizBaremacion[18][1]="20";
	matrizBaremacion[18][2]="Medio Bajo";

	matrizBaremacion[19][0]="18";
	matrizBaremacion[19][1]="27";
	matrizBaremacion[19][2]="Medio Bajo";

	matrizBaremacion[20][0]="19";
	matrizBaremacion[20][1]="34";
	matrizBaremacion[20][2]="Medio";

	matrizBaremacion[21][0]="20";
	matrizBaremacion[21][1]="41";
	matrizBaremacion[21][2]="Medio";

	matrizBaremacion[22][0]="21";
	matrizBaremacion[22][1]="54";
