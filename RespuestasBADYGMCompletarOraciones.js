...
function matrizRespuestasCompletar(matrizRespuestas){
	...
	matrizRespuestas[1][1]="s";//respuesta correcta
	matrizRespuestas[1][2]="";//respuesta del estudiante

	matrizRespuestas[2][0]="2";
	matrizRespuestas[2][1]="z";
	...
	matrizRespuestas[10][1]="o";
	matrizRespuestas[10][2]="";
	
	matrizRespuestas[11][0]="11";
	matrizRespuestas[11][1]="s";
